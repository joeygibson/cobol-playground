       ...
       FILE-CONTROL.
       SELECT SalesFile ASSIGN TO 'data/e2g.dat'
           ORGANIZATION IS LINE SEQUENTIAL.
       SELECT SalesReport ASSIGN TO 'output/e2g.rpt'
           ORGANIZATION IS LINE SEQUENTIAL.
       ...
       01  ReportHeading.
           02 FILLER PIC X(35) VALUE 
              "        Electronics2Go Sales Report".
      
       01  SubjectHeading.
           02 FILLER PIC X(43) VALUE 
              "State Name      Branch  SalesId  SalesTotal".
       ...
       Begin.
           ...
           PERFORM UNTIL EndOfSalesFile
             ...
             PERFORM SumSalesForState UNTIL 
               StateName NOT = PrevStateName OR EndOfSalesFile
       ...
       SumSalesForState.
           ...
           MOVE ZEROES TO BranchTotal

           PERFORM SumSalesForBranch UNTIL 
             BranchId NOT = PrevBranchId OR 
             StateName NOT = PrevStateName OR EndOfSalesFile
       ...
       SumSalesForBranch.
           ...
           MOVE ZEROES TO SalespersonTotal

           PERFORM SumSalespersonSales UNTIL 
             SalesPersonId NOT = PrevSalesPersonId OR
             BranchId NOT = PrevBranchId OR
             StateName NOT = PrevStateName OR EndOfSalesFile
       ...
       SumSalespersonSales.
           ADD ValueOfSale TO SalespersonTotal, BranchTotal, StateTotal,
             FinalTotal
